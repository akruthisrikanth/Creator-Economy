...
A.TikTok_total_creations_for_top_n_tracks AS TikTok_total_creations_for_top_n_tracks,
A.TikTok_Genz_followers_percentage,
A.Instagram_Genz_followers_percentage,
A.Youtube_Genz_subscribers_percentage,
B.Z_Score
FROM
